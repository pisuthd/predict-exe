...
import { TrendingUp, TrendingDown, Zap, AlertCircle, Target, ArrowRight } from 'lucide-react';
import BTCPrice from '@/components/Main/BTCPrice';
import HouseStatus from '@/components/Main/HouseStatus';
import LiveActivity, { ActivityItem } from '@/components/Main/LiveActivity';
import PoolDistribution from '@/components/Main/PoolDistribution';
    ...
    return (
        <div className="min-h-screen">
            <div className="max-w-7xl mx-auto px-4 py-8">
                {/* Header */}
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-cyan-500 mb-2">Predict</h1>
                    <p className="text-gray-400">Make your prediction and earn Prediction Points • Convert to FLIP tokens</p>
                </div>

                {/* FLIP Rewards Banner */}
                <div className="mb-8 bg-gradient-to-r from-pink-500/10 to-purple-500/10 border-2 border-pink-500/30 p-6">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                            <Target className="w-8 h-8 text-pink-500" />
                            <div>
                                <h3 className="text-xl font-bold text-pink-400">Earn FLIP Tokens</h3>
                                <p className="text-gray-400 text-sm">Win predictions → Get PP → Convert to FLIP tokens</p>
                            </div>
                        </div>
                        <div className="text-right">
                            <div className="text-2xl font-bold text-pink-500">1,250 PP</div>
                            <div className="text-sm text-gray-400">Your Balance</div>
                            <button className="mt-2 bg-gradient-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-black font-bold px-4 py-2 rounded-lg transition-all transform hover:scale-105 flex items-center space-x-2">
                                <span>Convert to FLIP</span>
                        ...
                        <div className="bg-black border-2 border-cyan-500 p-4">
                            <div className="flex items-center justify-between mb-2">
                                <div className="flex items-center space-x-2">
                                    ...
                                    <span className="text-cyan-500 ml-4 font-bold">MASSAFLIP.EXE</span>
                                </div>
